...

{
    date
    run_variant \
        "official_mobilefacenet/student_distill_w1_pairft_cfp_score_a" \
        "${LOG_DIR}/s2_w1_pairft_cfp_score_a_e8.log" \
        1.0 0.8 12.0 0.03
    date
    run_variant \
        "official_mobilefacenet/student_distill_w1_pairft_cfp_score_b" \
        "${LOG_DIR}/s2_w1_pairft_cfp_score_b_e8.log" \
        1.25 0.65 12.0 0.03
    date
} > "${LOG_DIR}/s2_w1_pairft_cfp_score_sweep.log" 2>&1 &
