...

{
    date
    run_variant \
        "official_mobilefacenet/student_distill_w1_pairft_score_a" \
        "${LOG_DIR}/s2_w1_pairft_score_a_e8.log" \
        1.25 0.65 12.0 0.03
    date
    run_variant \
        "official_mobilefacenet/student_distill_w1_pairft_score_b" \
        "${LOG_DIR}/s2_w1_pairft_score_b_e8.log" \
        1.50 0.55 12.0 0.025
    date
    run_variant \
        "official_mobilefacenet/student_distill_w1_pairft_score_c" \
        "${LOG_DIR}/s2_w1_pairft_score_c_e8.log" \
        1.75 0.45 10.0 0.025
    date
} > "${LOG_DIR}/s2_w1_pairft_score_sweep.log" 2>&1 &
