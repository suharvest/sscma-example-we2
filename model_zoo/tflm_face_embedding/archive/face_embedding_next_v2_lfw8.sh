...
OUT="official_mobilefacenet/iddistill_v2_lfw8"
LOG="logs/iddistill_v2_lfw8.log"
...

{
    ...
    /home/harve/.local/bin/uv run python -u train_mfn_student_pair_finetune.py \
        ...
        --negative-margin 0.025 \
        --threshold-weight 1.1 \
        --threshold 0.17 \
        --threshold-margin 0.06 \
        --teacher-pair-weight 2.0 \
        --hard-positive-fraction 0.45 \
        --hard-negative-fraction 0.35 \
        --mine-hard-positives 400 \
        --mine-hard-negatives 2600 \
        --mine-teacher-hard-negatives 500 \
        --arcface-weight 0.006 \
        --arcface-scale 32.0 \
        --arcface-margin 0.18 \
        --arcface-min-images 2 \
        --arcface-steps-per-epoch 60 \
        --identity-distill-weight 0.35 \
    ...
    /home/harve/.local/bin/uv run python -u evaluate_embedding_models.py \
        ...
        --model v2lfw8="${OUT}/mfn_w1_pairft_128d.int8.tflite"
    date
} > "${LOG}" 2>&1
