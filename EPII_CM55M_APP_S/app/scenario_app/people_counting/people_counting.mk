...
APPL_DEFINES += -DSSCMA
APPL_DEFINES += -DSSCMA_PEOPLE_COUNTING
...
override LINKER_SCRIPT_FILE := $(SCENARIO_APP_ROOT)/$(APP_TYPE)/people_counting.sct
else#TOOLChain
...
LIB_SSCMA_MICRO_DIR += $(LIBRARIES_ROOT)/sscma_micro/sscma/extension/counter
